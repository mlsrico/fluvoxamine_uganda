...
# Mortality ----
crude <- readRDS("article and review/figures/KM curves/rds/mortality_crude.rds")
ipw <- readRDS("article and review/figures/KM curves/rds/mortality_ipw.rds")
outs <- readRDS("article and review/figures/KM curves/rds/mortality_outliers.rds")
